(function() {
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      results[args] === undefined && (results[args] = func.apply(this, arguments));
      return results[args];
    };
  };
  ...
  _.shuffle = function(array) {
    ...
    _.each(newArray, function(item, index) {
      var randomIndex = Math.floor(Math.random() * (newArray.length-1));
      var temp = item;
  ...
  _.sortBy = function(collection, iterator) {
    ...
    if (typeof iterator === 'function') {
      for (var i = 0; i < collection.length; i++) {
        if (iterator(collection[i]) !== collection[i]) {
          init = false;
        }
      }
    }
  ...
  _.zip = function() {
    ...
    for (var i = 0; i < arguments.length; i++) {
      (maxLength < arguments[i].length) && (maxLength = arguments[i].length);
    }
